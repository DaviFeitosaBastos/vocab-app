...
from ui import main_menu, clear, search_menu
from utils import (
    search_word,
    load_dictionary,
    load_progress,
        ...
        try:
            ...
            match choose:
                case 1:
                    ...
                    print(
                        Panel(
                            f"[bold blue]The word today is[/]\n"
                            f"[bold cyan]★ [bold blue]{daily_word[0]['Word']}[/]\n★ [bold blue]Meaning[/] 🢚 {daily_word[0]['Meanings']}[/]",
                            title="[cyan]Daily word",
                            style="cyan",
                        )
                    )
                ...
                case 3:
                    ...
                    if result:
                        ...
                        print(
                            Panel(
                                f"[cyan]The word [red]|{word}|[/] was not found[/]",
                                title="[red]Word not found!",
                                style="red",
                            )
                        )
                        Prompt.ask("[bold blue]Press enter to return to menu")
